...
console.log(cut[0].charAt(cut[0].length-2), cut[0].charAt(cut[0].length-1))
    switch (cut[0].charAt(cut[0].length-2)) {
      case '1': return wynik += ' złotych'
      default: {
        switch (cut[0].charAt(cut[0].length-1)) {
          case '2': return wynik +=  ' złote' + grosze
          case '3': return wynik +=  ' złote' + grosze
          case '4': return wynik +=  ' złote' + grosze
          default: return wynik += ' złotych' + grosze
        }
      }
    }
    }
